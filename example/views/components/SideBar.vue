<template>
  <div class="components-box">
    <div class="components-title">SideBar 侧边栏</div>

    <div class="components-wrapper">
      <ul>
        <li>
          <div class="components-content">
            <h2 class="h2">SideBar 侧边栏</h2>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                使用
                <code>dy-sidebar</code> 组件绑定
                <code>:is-show.sync</code> 参数即可
              </p>
              <p>
                侧边栏的状态是根据
                <code>:is-show.sync</code> 所绑定的值来改变状态的
              </p>

              <br>
              <p>参数设置如下：</p>
              <p>
                <code>:is-show.sync</code> -- 布尔值，用于显示侧边栏的状态
              </p>
              <p>
                <code>:width</code> -- 数值或者字符串，用于设置侧边栏的宽度，默认为
                <code>250</code>
              </p>
              <p>
                <code>placement</code> -- 用于指定侧边栏弹出方向
              </p>
            </div>
          </div>

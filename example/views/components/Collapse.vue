<template>
  <div class="components-box">
    <div class="components-title">Collapse 折叠菜单</div>

    <div class="components-wrapper">
      <ul>
        <li>
          <div class="components-content">
            <h2 class="h2">Collapse 折叠菜单（默认）</h2>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                使用
                <code>dy-collapse</code> 组件包裹
                <code>dy-collapse-item</code> 组件使用即可
              </p>
              <p>
                <code>dy-collapse-item</code> 组件中使用
                <code>slot="content"</code> 参数来标记为折叠内容，未添加的默认为标题内容
              </p>

              <br>
              <p>参数设置如下：</p>
              <p>
                <code>v-model</code> -- 绑定的值来标记默认开启哪一个
              </p>
              <p>
                <code>name</code> -- 标记选项
              </p>
              <p>
                <code>:accordion</code> -- 标记是否开启手风琴选项，默认为
                <code>false</code>
              </p>
            </div>
          </div>
    ...
    &lt;/script&gt;
        ...
        <li>
          <div class="components-content">
            <h2 class="h2">Collapse 折叠菜单（手风琴）</h2>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                使用
                <code>:accordion</code> 参数来开启手风琴效果
              </p>
            </div>
          </div>

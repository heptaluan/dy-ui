        ...
        <li>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                直接使用
                <code>dy-progress</code> 组件并指定当前进度即可，需要注意，
                <code>:progress</code> 参数为必填项
              </p>

              <br>
              <p>参数设置如下：</p>
              <p>
                <code>:progress</code> -- 必填项，指定进度条当前的进度
              </p>
              <p>
                <code>color</code> -- 进度条的样式颜色，默认为
                <code>default</code>，可选参数有
                <code>success</code>，
                <code>warning</code>，
                <code>danger</code>
              </p>
              <p>
                <code>:textInside</code> -- 设定进度条文本内容的显示位置，默认为外部，指定为
                <code>true</code> 后文本内容在内部展示
              </p>
              <p>
                <code>:showProgressText</code> -- 指定是否显示进度条的文本内容，默认是显示的，指定为
                <code>false</code> 后文本内容将会被隐藏
              </p>
              <p>
                <code>:striped</code> -- 指定是否显示进度条的斑马线纹路样式，默认是不显示的，指定为
                <code>true</code> 后可以开启
              </p>
              <p>
                <code>:active</code> -- 指定是否激活斑马线纹路的动画效果，默认是不展示的，指定为
                <code>true</code> 后可以开启
              </p>
            </div>
          </div>
    ...
    &lt;/template&gt;
        ...
        <li>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                如果需要文本在进度条内部显示，只需要指定
                <code>:textInside</code> 参数为
                <code>true</code> 即可
              </p>
            </div>
          </div>
        ...
        <li>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                如果需要不显示文本内容，只需要指定
                <code>:showProgressText</code> 参数为
                <code>false</code> 即可，默认是显示的
              </p>
            </div>
          </div>
    ...
    &lt;/template&gt;
        ...
        <li>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              <p>
                如果需要激活斑马线的动画样式，只需要指定
                <code>:active</code> 参数为
                <code>true</code> 即可
              </p>
            </div>
          </div>

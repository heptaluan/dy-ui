...
<div class="components-code">
    ...
    <div class="code-tip">
        ...
        <p>提供三个参数 <code>l</code>，<code>m</code>，<code>s</code> 用以区分大小，指定 <code>size</code> 参数即可</p>
    </div>
</div>
...
<div class="components-code">
    ...
    <div class="code-tip">
        <p>图标使用的为阿里巴巴矢量图标库</p>
        <p>配合 <code>dy-icon</code> 组件使用，指定 <code>type</code> 为对应的图标类型即可，大小可以使用 <code>size</code> 属性来指定</p>
    </div>
</div>

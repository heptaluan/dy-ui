    ...
    &lt;/template&gt;
        ...
        <li>
          ...
          <div class="components-code">
            <div class="code-title">示例代码</div>
            <div class="code-tip">
              <p>默认按钮大小为上图中的第二个示例</p>
              <p>
                提供三个参数
                <code>l</code>，
                <code>m</code>，
                <code>s</code> 用以区分大小，指定
                <code>size</code> 参数即可
              </p>
            </div>
          </div>
    ...
    &lt;/template&gt;
        ...
        <li>
          ...
          <div class="components-content">
            ...
            <dy-button type="default">
              <dy-icon size="14" type="&#xe62f;"></dy-icon>下一页
            </dy-button>
            <dy-button type="default">
              下一页
              <dy-icon size="14" type="&#xe62e;"></dy-icon>
            ...
            <dy-button type="default">
              <dy-icon size="14" type="&#xe62c;"></dy-icon>上一页
            </dy-button>
          </div>
          ...
          <div class="components-code">
            ...
            <div class="code-tip">
              ...
              <p>
                配合
                <code>dy-icon</code> 组件使用，指定
                <code>type</code> 为对应的图标类型即可，大小可以使用
                <code>size</code> 属性来指定
              </p>
            </div>
          </div>

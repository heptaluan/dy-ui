...
<div class="components-box">
        ...
        <div class="components-title">DropDown 下拉菜单</div>
...
<div class="components-content">
    <h2 class="h2">DropDown 下拉菜单（默认，鼠标移入激活菜单）</h2>
...
<div class="components-code">
    ...
    <div class="code-tip">
        <p>使用 <code>v-dropdown</code> 指令绑定需要显示的下拉菜单，下拉组件则需要指定与之对应的 <code>ref</code> 的值</p>
        <p>然后只需使用 <code>dy-dropdown</code> 组件包裹 <code>dy-dropdown-item</code> 组件即可</p>
        <p><code>dy-dropdown-item</code> 组件当中的内容可以自行定义</p>

        <br>
        <p>可选参数：</p>
        <p><code>trigger</code>  --  下拉菜单触发方式，默认为 <code>focus</code>，可选值为 <code>click</code></p>
        <p><code>:header</code>  --  布尔值，指定下拉菜单标题（分组用），默认为 <code>false</code></p>
    </div>
</div>
...
<div class="components-content">
    <h2 class="h2">DropDown 下拉菜单（点击激活菜单）</h2>
...
<div class="components-content">
    <h2 class="h2">DropDown 下拉菜单（指定菜单标题）</h2>
...
<div class="components-code">
    <div class="code-title">示例代码</div>
    <div class="code-tip">
        <p>设置 <code>:header</code> 参数为 <code>true</code>，指定菜单标题</p>
    </div>
</div>
